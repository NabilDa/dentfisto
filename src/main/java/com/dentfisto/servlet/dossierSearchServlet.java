...
public class DossierSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        //
        // Step 1 – find patient
        // SELECT * FROM patient WHERE (nom LIKE ? OR telephone LIKE ?) AND dentiste_id=? LIMIT 1
        //
        ...
        // SELECT consultation_id, libelle FROM acte_consultation WHERE consultation_id IN (...)
        //
