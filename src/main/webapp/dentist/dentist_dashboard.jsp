...
<div class="overview-grid">
    <div class="dash-card">
        <div class="card-header">
            <h3>RV du jour</h3>
            <a href="${pageContext.request.contextPath}/dentist/appointments" class="btn-text">Voir tout →</a>
        </div>
        <div class="rv-list">
            <c:choose>
                        ...
                        <c:if test="${rv.status != 'en_attente'}">
                            <div class="rv-item">
                                ...
                                <c:if test="${rv.status == 'termine' && rv.ordonnanceSkipped}">
                                    <a href="${pageContext.request.contextPath}/dentist/ordonnance?rvId=${rv.id}"
    ...
    <div class="dash-card">
        ...
        <div class="quick-actions">
            <a href="${pageContext.request.contextPath}/dentist/appointments" class="qa-btn">
            ...
            <a href="${pageContext.request.contextPath}/dentist/patients" class="qa-btn">
            ...
            <a href="${pageContext.request.contextPath}/dentist/planning" class="qa-btn">
            ...
            <a href="${pageContext.request.contextPath}/dentist/dossier" class="qa-btn">
