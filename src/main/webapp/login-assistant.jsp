...
<body class="login-page role-assistant">
...
<header class="navbar">
    ...
    <div class="login-container">
        ...
        <div class="login-hero">
            <img src="${pageContext.request.contextPath}/images/assistant_link_img.png" alt="Clinic reception" class="hero-img">
            <div class="hero-overlay"></div>
            <div class="hero-tagline">
                <h2>Bonjour, Assistant</h2>
                <p>Connectez-vous pour commencer votre parcours de soins patients.</p>
            </div>
        </div>
